// src/components/teacher/course-management/ai-generate/ConfigPanel/SupplementaryContent.tsx
"use client";
...
const SupplementaryContent: React.FC<Props> = ({ content, onContentChange }) => (
