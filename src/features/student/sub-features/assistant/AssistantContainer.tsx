...
import { ReferenceItem } from '@/widgets/chat/UniversalChatWidget/MessageBubble/MessageReferences/MessageReferences';
import ChatFooter from '@/widgets/chat/UniversalChatWidget/ChatFooter/ChatFooter'; // 保留特定组件的路径
