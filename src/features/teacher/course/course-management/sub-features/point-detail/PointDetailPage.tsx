// src/app/teacher/(dashboard)/courses/[id]/syllabus/[pointId]/KnowledgeDetailPage.tsx
"use client";
import React, { useEffect, useState, useRef } from 'react';
import { useParams } from 'next/navigation';
import styles from './PointDetail.module.css';
import SyllabusSidebar from '@/features/teacher/course/course-management/sub-features/point-detail/components/SyllabusSidebar/SyllabusSidebar';
import PointHeader from '@/features/teacher/course/course-management/sub-features/point-detail/components/PointHeader/PointHeader';
import AuxiliarySidebar from '@/features/teacher/course/course-management/sub-features/point-detail/components/AuxiliarySidebar/AuxiliarySidebar';
...
import PointContentViewer from '@/features/teacher/course/course-management/sub-features/point-detail/components/PointContentViewer/PointContentViewer';
