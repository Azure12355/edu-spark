...
import { useFileUpload, UploadableFile } from '@/shared/hooks/useFileUpload'; // 引入新的Hook

// 组件导入保持不变

import styles from './DocumentImport.module.css';
import ImportHeader from '@/features/teacher/knowledge/document-import/components/ImportHeader/ImportHeader';
import ImportSourceTabs from '@/features/teacher/knowledge/document-import/components/ImportSourceTabs/ImportSourceTabs';
import FileUploadArea
    from "@/features/teacher/knowledge/document-import/components/FileUploadArea/FileUploadArea";
import ImportOptions
    from "@/features/teacher/knowledge/document-import/components/ImportOptions/ImportOptions";
import ImportActions
    from "@/features/teacher/knowledge/document-import/components/ImportActions/ImportActions";
import FileList from "@/features/teacher/knowledge/document-import/components/FileList/FileList";
