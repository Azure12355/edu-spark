...
import { KnowledgeFormatType } from '@/shared/types/knowledge';
import styles from './CreateKnowledgeModal.module.css';
import {KnowledgeBaseAddRequest} from "@/features/teacher/knowledge/knowledge-list/services/knowledgeService";
