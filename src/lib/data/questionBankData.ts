...
import { syllabusData, KnowledgePoint } from './syllabusData'; // 1. 导入 KnowledgePoint 类型和数据源
...
export const questionBankData: Record<string, Question[]> = {
    'p-1-2-1': [
        {
            id: 'q-001', points: findPoints(['p-1-2-1']), type: '单选题', difficulty: '简单',
        ...
        {
            id: 'q-002', points: findPoints(['p-1-2-1', 'p-1-2-2']), type: '多选题', difficulty: '中等',
    ...
    'p-2-1-2': [
        {
            id: 'q-003', points: findPoints(['p-2-1-2']), type: '判断题', difficulty: '简单',
        ...
        {
            id: 'q-004', points: findPoints(['p-2-1-2']), type: '简答题', difficulty: '中等',
        ...
        {
            id: 'q-005', points: findPoints(['p-2-1-2']), type: '编程题', difficulty: '困难',
    ...
    'p-3-1-3': [
        {
            id: 'q-001', points: findPoints(['p-2-1-2']), type: '单选题', difficulty: '简单',
            stem: '在算法分析中，大O表示法（Big O notation）通常用来描述算法的什么特性？',
            options: ['最佳情况下的时间复杂度', '平均情况下的时间复杂度', '最坏情况下的时间复杂度', '算法的精确执行时间'],
            answer: '最坏情况下的时间复杂度',
            analysis: '大O表示法描述了算法执行时间（或空间）的上界，即在最坏情况下的增长趋势。',
        ...
        {
            id: 'q-002', points: findPoints(['p-2-1-2']), type: '多选题', difficulty: '中等',
            stem: '下列哪些算法的时间复杂度为 O(n log n)？',
            options: ['快速排序 (平均情况)', '归并排序', '堆排序', '冒泡排序 (最坏情况)'],
            answer: ['快速排序 (平均情况)', '归并排序', '堆排序'],
            analysis: '快速排序的平均和最佳时间复杂度是 O(n log n)，最坏是 O(n^2)。归并排序和堆排序在所有情况下都是 O(n log n)。冒泡排序是 O(n^2)。',
        ...
        {
            id: 'q-006', points: findPoints(['p-2-1-2']), type: '填空题', difficulty: '简单',
