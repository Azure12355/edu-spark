...
export const questionBankData: Record<string, Question[]> = {
    'p-1-2-1': [
        {
            id: 'q-001', pointId: 'p-1-2-1', type: '单选题', difficulty: '简单',
        ...
        {
            id: 'q-002', pointId: 'p-1-2-1', type: '多选题', difficulty: '中等',
    ...
    'p-2-1-2': [
        {
            id: 'q-003', pointId: 'p-2-1-2', type: '判断题', difficulty: '简单',
        ...
        {
            id: 'q-004', pointId: 'p-2-1-2', type: '简答题', difficulty: '中等',
        ...
        {
            id: 'q-005', pointId: 'p-2-1-2', type: '编程题', difficulty: '困难',
    ...
    'p-3-1-3': [
        {
            id: 'q-006', pointId: 'p-3-1-3', type: '填空题', difficulty: '简单',
