...
export const mockFolders: QuestionFolder[] = [
    ...
    { id: 'folder-3', name: '第三章：控制流', parentId: null, questionCount: 3 },
    { id: 'folder-4', name: '第四章：函数与模块', parentId: null, questionCount: 2 },
    { id: 'folder-1-1', name: '1.1 基础语法', parentId: 'folder-1', questionCount: 2 },
    { id: 'folder-1-2', name: '1.2 环境配置', parentId: 'folder-1', questionCount: 3 },
...
export const mockQuestions: Question[] = [
    ...
    // ... 保持你现有的其他题目数据 ...
    // 为了演示，我再加几个
    { id: 'q-8', folderId: 'folder-1-2', type: 'short-answer', content: '如何安装第三方库？', answer: '使用 pip install <package_name>', difficulty: 'easy', creator: '王老师', createdAt: '2024-05-23', analysis: '' },
    { id: 'q-9', folderId: 'folder-1-2', type: 'short-answer', content: '虚拟环境的作用是什么？', answer: '项目隔离，避免包冲突', difficulty: 'easy', creator: '王老师', createdAt: '2024-05-23', analysis: '' },
    { id: 'q-10', folderId: 'folder-1-2', type: 'short-answer', content: '什么是PEP 8？', answer: 'Python代码风格指南', difficulty: 'easy', creator: '王老师', createdAt: '2024-05-23', analysis: '' },
    ...
    { id: 'q-16', folderId: 'folder-4', type: 'short-answer', content: '什么是*args和**kwargs？', answer: '用于接收不定长参数', difficulty: 'medium', creator: '王老师', createdAt: '2024-05-23', analysis: '' },
